...
//TTGLIST= TGLYPHLIST  ;
 ...
 TMsgType=
   (t_Notice, t_Hint, t_System, t_Say, t_Mon, t_GM, t_Cust, t_Castle,t_hSystem,t_rSystem);
...
//  Pointer; //^integer;
 // PN_GETRGB=string;
// TIPLocal=   procedure(sIPaddr:pchar;var sLocal:array of Char;size:integer);
  TIPLocal=procedure(sIPaddr: PChar; sLocal: PChar;
    nLength: Integer) stdcall;
...
TProcArray=array[0..999]of Tplugproc;
...
//  n2:integer;
  ...
  TonSellItemdata =packed  record
   ...
   Sellitemarr:array[0..9] of TOClientItem ; //    //NeedIdentify=1 表示用元宝交易，NeedIdentify=0 表示用金币
  end;
   tMAGICFIRE= record
    Targe:integer;
    color:integer;
 ...
 var
    ...
    mdbyzstring:string;
    RUNID2:INteger;
    topnpcarr:array[1..7]of Ttopnpc;
    HardwareID :string;
    RegUser    :string;
    RegSn      :string;
    SkeyId:array[1..10000]of Integer;
    keyStringType: T15keyString ;
    hadwareIdpos2:Integer;
    sEPEpassword82:STRING;
    RUNID1:Integer;
    sdbhackid:boolean;
// var
