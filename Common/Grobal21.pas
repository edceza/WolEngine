...
GS_CHANGEACCOUNTINFO=2;
 ...
 SS_CLOSESESSION=100;
 SG_USERACCOUNT=101;
 SG_USERACCOUNTNOTFOUND=102;
 SG_USERACCOUNTCHANGESTATUS=103;
 SS_SOFTOUTSESSION=104;
 SS_SERVERINFO=105;
 SS_KEEPALIVE=106;
 UNKNOWMSG=107;
  ...
  end;
{
 ...
 DBRecord.UserEntry.sAccount:=sAccount;
  ...
  DBRecord.UserEntryAdd.sMemo2:=sMemo
}
