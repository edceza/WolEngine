...
interface
uses
  Windows,Messages,Classes,SysUtils,IniFiles,DataBackUp;
type
  TProgram = record
    boGetStart   :Boolean;
...
var
  ...
  g_sNoticeUrl:String = 'www.npc8.com';
  ...
  g_sGameName      :String = '淡漠夕阳';
  g_sGameName1     :String = '淡漠夕阳';
  ...
  g_sM2Server_ProgramFile         :String = 'WolServer.exe';
  ...
  g_sM2Server_Config_RegServerAddr  :String = '127.0.0.1';
