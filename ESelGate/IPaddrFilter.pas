...
type
  TfrmIPaddrFilter = class(TForm)
    ...
    procedure MaxMsgLenChange(Sender: TObject);
...
begin
  ...
  Conf.WriteInteger(GateClass,'MaxMsgLen',Integer(nMaxMsgLen));
  Conf.Free;
  Close;
end;
...
procedure TfrmIPaddrFilter.MaxMsgLenChange(Sender: TObject);
begin
    nMaxMsgLen :=      MaxMsgLen.Value ;
end;
