...
//  HumanGrid.Cells[5,6]:=IntToStr(HumData.Abil.bt48);
  ...
  HumanGrid.Cells[8,6]:=IntToStr(HumData.wPKPoint);
  HumanGrid.Cells[9,6]:='';
...
begin
  ...
  ShowBagItem(10,'鞋子',ChrRecord.Data.HumItems[9]);
  ShowBagItem(11,'腰带',ChrRecord.Data.HumItems[10]);
  ShowBagItem(12,'宝石',ChrRecord.Data.HumItems[11]);
  ShowBagItem(13,'物品',ChrRecord.Data.HumItems[12]);
  for i:= Low(ChrRecord.Data.BagItems) to High(ChrRecord.Data.BagItems) do begin
    ShowBagItem(i + 14,IntToStr(i + 1),ChrRecord.Data.BagItems[i]);
  end;
end;
...
* Possible String Reference to: '闁z?滕]脣纼-\跩'
|
...
* Possible String Reference to: ']脣纼-\跩'
|
