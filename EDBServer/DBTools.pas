...
begin
  ...
  try
    ...
    begin
      ...
      for I := 0 to HumDataDB.m_QuickList.Count - 1 do
      begin
        nProcID:=I;
        ...
        try
         //如果是元神则不在hum.db里存
          if NewChrDB.Open  and  (SrcHumanRCD.Data.boYS) then
          begin
            if NewChrDB.ChrCountOfAccount(SrcHumanRCD.Data.sAccount) < 6 then
            begin
