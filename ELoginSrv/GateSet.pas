...
type
  TFrmGateSetting=class(TForm)
    ...
    procedure UseRanPassClick(Sender: TObject);
  private
...
begin
  ...
  Config.IniConf.WriteBool('Server','UseRanDomPass', Config.boUseRanDomPass);
end;
//004653B8
...
begin
 ...
 UseRanPass.Checked:= Config.boUseRanDomPass ;
end;
//00464CB0
...
procedure TFrmGateSetting.UseRanPassClick(Sender: TObject);
 var Config    :pTConfig;
begin
  Config:=@g_Config;
  Config.boUseRanDomPass:= UseRanPass.checked;
end;
