...
uses
  ...
  Dialogs, StdCtrls, Mask,  CastleManage, Castle, Guild, ComCtrls;
...
begin
  case nStute of
    ...
    1: begin
        ...
        DateTimePicker1.Date := m_AttackDate;
      end;
  end;
  LoadGuildList();
  ShowModal;
...
begin
  ...
  AttackDate := DateTimePicker1.Date;
  case nStute of
    0: begin
        if CheckBoxAll.Checked then begin
          ...
          for I := 0 to ListBoxGuild.Items.Count - 1 do
          begin
