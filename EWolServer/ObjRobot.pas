      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if AutoRunInfo.nMoethod < 300 then
...
begin
  ...
  LoadRobot();
            ...
            RobotHuManPlayer := TRobotObject.Create;
          RobotHuManPlayer.m_sCharName := 'sRobotName';

          RobotHuManPlayer.m_sMapName := '0';
          RobotHuManPlayer.m_PEnvir := g_MapManager.FindMap('0');
