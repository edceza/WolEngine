...
begin
  ...
  begin
    ...
    GridUserItem.Cells[4, I + 1] := format('%d/%d', [LoByte(Item.DC), HiByte(Item.DC)]);
    GridUserItem.Cells[5, I + 1] := format('%d/%d', [LoByte(Item.MC), HiByte(Item.MC)]);
    GridUserItem.Cells[6, I + 1] := format('%d/%d', [LoByte(Item.SC), HiByte(Item.SC)]);
    GridUserItem.Cells[7, I + 1] := format('%d/%d', [LoByte(Item.AC), HiByte(Item.AC)]);
    GridUserItem.Cells[8, I + 1] := format('%d/%d', [LoByte(Item.MAC), HiByte(Item.MAC)]);
  ...
  begin
    ...
    GridBagItem.Cells[4, I + 1] := format('%d/%d', [LoByte(Item.DC), HiByte(Item.DC)]);
    GridBagItem.Cells[5, I + 1] := format('%d/%d', [LoByte(Item.MC), HiByte(Item.MC)]);
    GridBagItem.Cells[6, I + 1] := format('%d/%d', [LoByte(Item.SC), HiByte(Item.SC)]);
    GridBagItem.Cells[7, I + 1] := format('%d/%d', [LoByte(Item.AC), HiByte(Item.AC)]);
    GridBagItem.Cells[8, I + 1] := format('%d/%d', [LoByte(Item.MAC), HiByte(Item.MAC)]);
  ...
  begin
    ...
    GridStorageItem.Cells[4, I + 1] := format('%d/%d', [LoByte(Item.DC), HiByte(Item.DC)]);
    GridStorageItem.Cells[5, I + 1] := format('%d/%d', [LoByte(Item.MC), HiByte(Item.MC)]);
    GridStorageItem.Cells[6, I + 1] := format('%d/%d', [LoByte(Item.SC), HiByte(Item.SC)]);
    GridStorageItem.Cells[7, I + 1] := format('%d/%d', [LoByte(Item.AC), HiByte(Item.AC)]);
    GridStorageItem.Cells[8, I + 1] := format('%d/%d', [LoByte(Item.MAC), HiByte(Item.MAC)]);
...
begin
  ...
  if (nLevel < 0) or (nLevel > High(Word)) or (nGold < 0) or (nGold > 200000000) or (nPKPoint < 0) or
    (nPKPoint > 2000000) or (nCreditPoint < 0) or (nCreditPoint > High(Byte)) or (nBonusPoint < 0) or (nBonusPoint > 20000000) then
  begin
