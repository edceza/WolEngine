...
uses
  ...
  Dialogs, StdCtrls, Grids, ObJBase;
...
begin
  ...
  begin
    ...
    if CheckBox2.checked then
      UserEngine.SendBroadCastMsgExt(Msg, t_hSystem, );
    if CheckBox3.checked then
      UserEngine.SendBroadCastMsgExt(Msg, t_rSystem);
    if CheckBox4.checked then
      UserEngine.SendBroadCastMsgExt(Msg, t_tSystem);
    MemoMsg.Lines.Add(g_Config.sSysMsgPreFix + Msg);
  end;
  ComboBoxMsg.ItemIndex := 0;
  //ComboBoxMsg.Text := '';
