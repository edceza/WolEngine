...
uses
  ...
  Dialogs, Grids, ComCtrls, StdCtrls, Spin, M2Share, grobal2;
...
//  exit;
  ...
  StringGridGameCmd.Cells[0, 38] := g_GameCommand.MEMBERFUNCTIONEX1.sCmd;
  StringGridGameCmd.Cells[1, 38] := IntToStr(g_GameCommand.MEMBERFUNCTIONEX1.nPermissionMin);
  StringGridGameCmd.Cells[2, 38] := '@' + g_GameCommand.MEMBERFUNCTIONEX1.sCmd;
  StringGridGameCmd.Objects[0, 38] := TObject(@g_GameCommand.MEMBERFUNCTIONEX1);
end;
...
begin
  ...
  RefGameMasterCmd(@g_GameCommand.SPIRITSTOP,
    ...
    '');
   RefGameMasterCmd(@g_GameCommand.MakeItemDrop,
    '@' + g_GameCommand.MakeItemDrop.sCmd,
    '');
end;
