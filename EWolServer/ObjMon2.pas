...
///
  ...
  Tbigheatmonsteraxe = class(TAnimalObject) //¹Ì¶¨Î»ÖÃÈ«ÆÁÄ»¹¥»÷ +Âé±Ô
  private
    procedure FlyAxeAttack(Target: TBaseObject);
  public
    constructor Create(); override;
...
///
  Tbigearmonsteraxe = class(TAnimalObject) //¹Ì¶¨Î»ÖÃÈ«ÆÁÄ»¹¥»÷ +Âé±Ô
  private
    procedure FlyAxeAttack(Target: TBaseObject);
  public
    constructor Create(); override;
...
begin
  if not m_boGhost and
    ...
    (m_wStatusTimeArr[POISON_STONE {5 0x6A}] = 0) then
  begin
    if Pos('°®ÇéÖ®Ê÷',m_sCharName)=0 then
