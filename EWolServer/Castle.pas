...
//    nStatus     :Integer;   //0x0C
  ...
  public
    ...
    function AddAttackerInfo(Guild: TGuild;nTime:Integer=-1): Boolean;
    procedure ClearAttackerInfo;
...
procedure TUserCastle.ClearAttackerInfo;
var
  AttackerInfo: pTAttackerInfo;
  i:Integer;
begin
  for I := 0 to m_AttackWarList.Count - 1 do
  begin
    AttackerInfo:=pTAttackerInfo(m_AttackWarList[i]);
    Dispose(AttackerInfo);
  end;
  m_AttackWarList.Clear;
  SaveAttackSabukWall();
...
function TUserCastle.AddAttackerInfo(Guild: TGuild;nTime:Integer=-1): Boolean; //00490CD8
var
  AttackerInfo: pTAttackerInfo;
begin
  Result := False;
  ...
  if nTime=-1 then
    ...
    AttackerInfo.AttackDate := AddDateTimeOfDay(Now, nTime);
